...
export function ProjectEditDialog({ project }: { project: ProjectRow }) {
        ...
        {open ? (
          <div className="dialog-panel">
            ...
            <div className="dialog-body">
              <ProjectForm project={project} onSubmitRef={(fn) => { submitFormRef.current = fn }} hideActions onClose={hide} />
            </div>

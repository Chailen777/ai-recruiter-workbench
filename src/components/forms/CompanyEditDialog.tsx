...
type CompanyData = Parameters<typeof CompanyForm>[0]['company']

export function CompanyEditDialog({ company }: { company: NonNullable<CompanyData> }) {
        ...
        {open ? (
          <div className="dialog-panel">
            ...
            <div className="dialog-body">
              <CompanyForm company={company} onSubmitRef={handleSubmitRef} hideActions onClose={hide} />
            </div>

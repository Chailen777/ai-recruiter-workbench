...
export function KnowledgeEditDialog({ knowledge }: { knowledge: KnowledgeRow }) {
        ...
        {open ? (
          <div className="dialog-panel">
            ...
            <div className="dialog-body">
              <KnowledgeForm knowledge={knowledge} onSubmitRef={handleSubmitRef} hideActions onClose={hide} />
            </div>
